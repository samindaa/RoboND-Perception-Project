...
def compute_color_histograms(cloud, using_hsv=False):
    ...
    channel_1_hist = np.histogram(channel_1_vals, bins=32)
    channel_2_hist = np.histogram(channel_2_vals, bins=32)
    channel_3_hist = np.histogram(channel_3_vals, bins=32)
